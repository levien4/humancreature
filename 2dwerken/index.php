...
<html>
<head>
<title>2d Werken</title>
<meta name="description" content="collagedruk; indien er andere technieken aan toegevoegd zijn"/>
<?php print file_get_contents('http://www.humancreature.nl/scripts.php')?>
</head>
<body>
<?php include_once("www.humancreature.nl/analyticstracking.php")?>
<center>
<div id="container">
	<div id="header">
		<h1>
			<font>
				Human Creature:<br><li>2d Werken</li>
			</font>
		</h1>
	</div>
	<div id="center">
